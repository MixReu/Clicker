...
# ================ НАСТРОЙКИ ================
BOT_TOKEN = os.environ.get("BOT_TOKEN", "6869991940:AAF5qjZD2XrCyCefZYP4WFY96cGPDELm3bw")
ACCESS_TOKEN = os.environ.get("ACCESS_TOKEN", "17ea3986779378d08e4d6dd1060dd3f87809b2d77accef1145ac9cb2f56a7d90")
MERCHANT_ID = os.environ.get("MERCHANT_ID", "128")
